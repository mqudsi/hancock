...
struct
  ...
  val DFLAG = false
  val HFLAG = true (* HANCOCK  -- not yet used. *)
  ...
  struct
    ...
    val convert_function_args_to_pointers = false      (* ansic *) (* HANCOCK *)
    ...
    val allow_non_constant_local_initializer_lists = true (* HANCOCK (ansic is false )*)
